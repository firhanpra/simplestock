...
import 'package:inventory/model/stock_opname_model.dart';
  ...
  Future<void> getData() async {
    ...
    try {
      var response = await dio.get(
        'https://stockskripsi.000webhostapp.com/api/stock-opname?search=&date=$date',
      );
  ...
  Future<void> postStock() async {
    ...
    try {
      var response = await dio.post(
        'https://stockskripsi.000webhostapp.com/api/stock-opname',
        data: data,
      );
      print(response.data);
      isLoading(false);
